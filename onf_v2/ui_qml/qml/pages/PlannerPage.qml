...
Item {
    ...
    ListModel {
        id: planModel
        ListElement { taskState: 0; title: "영어 독해 지문 2개"; start: "09:00"; end: "09:45"; duration: "45분" }
        ListElement { taskState: 1; title: "수학 오답노트 정리"; start: "11:00"; end: ""; duration: "60분" }
        ListElement { taskState: 2; title: "한국사 4강 복습"; start: ""; end: ""; duration: "30분" }
        ListElement { taskState: 0; title: "과학 개념 문제 20개"; start: "20:00"; end: "21:00"; duration: "60분" }
    }
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ActionButton { text: "‹"; onClicked: root.feedbackRequested("이전 날짜") }
            Rectangle {
                ...
                Text { anchors.centerIn: parent; text: "2026년 7월 20일"; color: Theme.text; font.pixelSize: 13; font.weight: Font.DemiBold }
            }
            ActionButton { text: "›"; onClicked: root.feedbackRequested("다음 날짜") }
            Rectangle {
                    ...
                    RowLayout {
                        ...
                        ActionButton {
                            ...
                            onClicked: {
                                ...
                                planModel.append({taskState: 0, title: taskInput.text, start: startInput.text, end: endInput.text, duration: durationInput.text})
                        ...
                        delegate: Rectangle {
                            ...
                            RowLayout {
                                ...
                                Button {
                                    ...
                                    onClicked: planModel.setProperty(planRow.index, "taskState", (planRow.taskState + 1) % 3)
                                ...
                                TextField { Layout.fillWidth: true; text: planRow.title; font.pixelSize: 12; selectByMouse: true; background: Item {} }
                                TextField { Layout.preferredWidth: 72; text: planRow.start; placeholderText: "--:--"; horizontalAlignment: Text.AlignHCenter; background: Item {} }
                                TextField { Layout.preferredWidth: 72; text: planRow.end; placeholderText: "--:--"; horizontalAlignment: Text.AlignHCenter; background: Item {} }
                                TextField { Layout.preferredWidth: 72; text: planRow.duration; placeholderText: "--분"; horizontalAlignment: Text.AlignHCenter; background: Item {} }
                                Button {
                                    id: deleteButton
                                    Layout.preferredWidth: 30
                                    Layout.preferredHeight: 30
                                    text: "×"
                                    onClicked: { planModel.remove(planRow.index); root.feedbackRequested("계획을 삭제했습니다.") }
